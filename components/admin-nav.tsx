...
export async function AdminNav() {
  ...
  return <div className="flex h-full min-h-0 flex-col px-5 py-6">
    ...
    <div className="sidebar-note mt-auto rounded-2xl bg-emerald-50 p-4"><div className="sidebar-label text-sm font-semibold text-emerald-950">Un pas à la fois</div><p className="sidebar-label mt-1 text-xs leading-5 text-emerald-800/80">Suivez chaque lecture jusqu’au dernier Jukki.</p><span className="sidebar-note-icon hidden text-xl text-emerald-800">☾</span></div>
